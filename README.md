...
Clica em Novo conselho
O app consome a Advice Slip API
O conselho é exibido na tela
O usuário pode clicar em Traduzir conselho
O app consome a MyMemory Translation API
O usuário pode clicar em Salvar no Firebase
O conselho é salvo na coleção conselhos no Firestore
O usuário pode clicar em Ver conselhos salvos
...
Como instalar
Baixe o arquivo APK no celular Android.
Caso apareça um aviso de segurança, permita a instalação de apps de fontes desconhecidas.
Abra o arquivo APK baixado.
Clique em instalar.
Após a instalação, abra o aplicativo ConselhoJá.
...
✅ Requisitos atendidos
 ...
 Tema livre
 Consumo de API externa
 Exibição de dados de API
 Integração com Firebase
 Código-fonte Dart corretamente versionado
 README documentado
 Arquitetura da aplicação descrita
 Aplicação pronta para prints
 APK para testes
📚 Aprendizados
